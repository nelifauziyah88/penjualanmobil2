...
<body>
    <h1>Selamat Ulang Tahun Kak Avrill</h2>
        <script>
            var rnd = Math.random,
                flr = Math.floor;
        ...
        <center><br>
            <font face="Abel" size="6px" color="grey"><b></b>
                ...
                <font size="3px">
                    ...
                    <marquee scrollamount="5" width="630" height="20" behavior="alternate">Selamat ulang tahun Kak, Semoga panjang umur, murah rejeki, dan sehat selalu. Semoga yang di semogakan tersemogakan. WYATB kakk..</marquee>
                    <font color="white"> ]</font>
                    <br><br>
